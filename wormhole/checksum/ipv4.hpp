...
namespace WarGrey::STEM {
	unsigned short checksum_ipv4(const uint8_t* message, size_t start, size_t end);
	unsigned short checksum_ipv4(unsigned short accumulated_crc, const uint8_t* message, size_t start, size_t end);
	unsigned short checksum_ipv4(unsigned short* accumulated_crc, const uint8_t* message, size_t start, size_t end);
