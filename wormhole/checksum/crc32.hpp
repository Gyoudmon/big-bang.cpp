...
namespace WarGrey::STEM {
	unsigned long checksum_crc32(const uint8_t* message, size_t start, size_t end);
	unsigned long checksum_crc32(unsigned long accumulated_crc, const uint8_t* message, size_t start, size_t end);
	unsigned long checksum_crc32(unsigned long* accumulated_crc, const uint8_t* message, size_t start, size_t end);
