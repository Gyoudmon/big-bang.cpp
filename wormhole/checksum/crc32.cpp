...
static unsigned long update_crc(unsigned long crc, const uint8_t* message, size_t start, size_t end) {
    unsigned long c = crc;
...
/*************************************************************************************************/
unsigned long WarGrey::STEM::checksum_crc32(const uint8_t* message, size_t start, size_t end) {
    return update_crc(0xFFFFFFFFL, message, start, end) ^ 0xFFFFFFFFL;
}

unsigned long WarGrey::STEM::checksum_crc32(unsigned long acc_crc, const uint8_t* message, size_t start, size_t end) {
