...
namespace GYDM {
    ...
    /*********************************************************************************************/
    __lambda__ SDL_Surface* game_text_surface(const std::string& text, const shared_font_t& font, GYDM::TextRenderMode mode, const GYDM::RGBA& fgc, const GYDM::RGBA& bgc, int wrap = 0);
    __lambda__ SDL_Texture* game_text_texture(SDL_Renderer* renderer, const std::string& text, const shared_font_t& font, GYDM::TextRenderMode mode, const GYDM::RGBA& fgc, const GYDM::RGBA& bgc, int wrap = 0);

    __lambda__ SDL_Texture* game_solid_text_texture(SDL_Renderer* renderer, const std::string& text, const shared_font_t& font, const GYDM::RGBA& fgc, int wrap = 0);
    __lambda__ SDL_Texture* game_shaded_text_texture(SDL_Renderer* renderer, const std::string& text, const shared_font_t& font, const GYDM::RGBA& fgc, const GYDM::RGBA& bgc, int wrap = 0);
    __lambda__ SDL_Texture* game_lcd_text_texture(SDL_Renderer* renderer, const std::string& text, const shared_font_t& font, const GYDM::RGBA& fgc, const GYDM::RGBA& bgc, int wrap = 0);
    __lambda__ SDL_Texture* game_blended_text_texture(SDL_Renderer* renderer, const std::string& text, const shared_font_t& font, const GYDM::RGBA& fgc, int wrap = 0);
