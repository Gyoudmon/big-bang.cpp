...
namespace WarGrey::STEM {
    ...
    class IPlane {
        ...
        public:
            ...
            virtual bool fill_matter_location(IMatter* g, float* x, float* y, float fx = 0.0F, float fy = 0.0F) = 0;
            virtual bool fill_matter_boundary(IMatter* g, float* x, float* y, float* width, float* height) = 0;
            virtual void fill_matters_boundary(float* x, float* y, float* width, float* height) = 0;
            virtual void insert_at(IMatter* g, float x = 0.0F, float y = 0.0F, float fx = 0.0F, float fy = 0.0F, float dx = 0.0F, float dy = 0.0F) = 0;
            virtual void insert_at(IMatter* g, IMatter* tg, float tfx, float tfy, float fx = 0.0F, float fy = 0.0F, float dx = 0.0F, float dy = 0.0F) = 0;
            virtual void insert_at(IMatter* g, IMatter* xtg, float xfx, IMatter* ytg, float yfy, float fx = 0.0F, float fy = 0.0F, float dx = 0.0F, float dy = 0.0F) = 0;
        ...
        public:
            virtual WarGrey::STEM::IMatter* get_focus_matter() = 0;
            virtual void set_caret_owner(IMatter* g) = 0;
            virtual void notify_matter_ready(IMatter* g) = 0;
            virtual void on_matter_ready(IMatter* g) = 0;
    ...
    class Plane : public WarGrey::STEM::IPlane {
        ...
        public:
            ...
            bool matter_unmasked(WarGrey::STEM::IMatter* g);

        public:
            void draw(SDL_Renderer* renderer, float X, float Y, float Width, float Height) override;

        public: // learn C++ "Name Hiding"
            using WarGrey::STEM::IPlane::fill_matter_location;
            ...
            bool fill_matter_location(IMatter* g, float* x, float* y, float fx = 0.0F, float fy = 0.0F) override;
            bool fill_matter_boundary(IMatter* g, float* x, float* y, float* width, float* height) override;
            void fill_matters_boundary(float* x, float* y, float* width, float* height) override;
            void insert_at(IMatter* g, float x = 0.0F, float y = 0.0F, float fx = 0.0F, float fy = 0.0F, float dx = 0.0F, float dy = 0.0F) override;
            void insert_at(IMatter* g, IMatter* tg, float tfx, float tfy, float fx = 0.0F, float fy = 0.0F, float dx = 0.0F, float dy = 0.0F) override;
            void insert_at(IMatter* g, IMatter* xtg, float xfx, IMatter* ytg, float yfy, float fx = 0.0F, float fy = 0.0F, float dx = 0.0F, float dy = 0.0F) override;
        ...
        public:
            WarGrey::STEM::IMatter* get_focus_matter() override;
            void set_caret_owner(IMatter* g) override;
            void notify_matter_ready(IMatter* g) override;
            void on_matter_ready(IMatter* g) override {}
