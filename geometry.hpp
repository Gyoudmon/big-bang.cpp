...
namespace WarGrey::STEM {
    ...
    void game_draw_point(SDL_Renderer* renderer, float x, float y, uint32_t rgb, uint8_t alpha = 0xFFU);
    void game_draw_point(SDL_Renderer* renderer, float x, float y, float hue, float saturation = 1.0f , float value = 1.0f, uint8_t alpha = 0xFFU);
    void game_draw_line(SDL_Renderer* renderer, float x1, float y1, float x2, float y2, uint32_t rgb, uint8_t alpha = 0xFFU);
    void game_draw_line(SDL_Renderer* renderer, float x1, float y1, float x2, float y2, float hue, float saturation = 1.0f, float value = 1.0f, uint8_t alpha = 0xFFU);
    
    void game_draw_rect(SDL_Renderer* renderer, SDL_FRect* box, uint32_t rgb, uint8_t alpha = 0xFFU);
    void game_draw_rect(SDL_Renderer* renderer, SDL_FRect* box, float hue, float saturation = 1.0f, float value = 1.0f, uint8_t alpha = 0xFFU);
    void game_fill_rect(SDL_Renderer* renderer, SDL_FRect* box, uint32_t rgb, uint8_t alpha = 0xFFU);
    void game_fill_rect(SDL_Renderer* renderer, SDL_FRect* box, float hue, float saturation = 1.0f, float value = 1.0f, uint8_t alpha = 0xFFU);
    void game_draw_rect(SDL_Renderer* renderer, float x, float y, float width, float height, uint32_t rgb, uint8_t alpha = 0xFFU);
    void game_draw_rect(SDL_Renderer* renderer, float x, float y, float width, float height, float hue, float saturation = 1.0f, float value = 1.0f, uint8_t alpha = 0xFFU);
    void game_fill_rect(SDL_Renderer* renderer, float x, float y, float width, float height, uint32_t rgb, uint8_t alpha = 0xFFU);
    void game_fill_rect(SDL_Renderer* renderer, float x, float y, float width, float height, float hue, float saturation = 1.0f, float value = 1.0f, uint8_t alpha = 0xFFU);

    void game_draw_square(SDL_Renderer* renderer, float cx, float cy, float apothem, uint32_t rgb, uint8_t alpha = 0xFFU);
    void game_draw_square(SDL_Renderer* renderer, float cx, float cy, float apothem, float hue, float saturation = 1.0f, float value = 1.0f, uint8_t alpha = 0xFFU);
    void game_fill_square(SDL_Renderer* renderer, float cx, float cy, float apothem, uint32_t rgb, uint8_t alpha = 0xFFU);
    void game_fill_square(SDL_Renderer* renderer, float cx, float cy, float apothem, float hue, float saturation = 1.0f, float value = 1.0f, uint8_t alpha = 0xFFU);

    void game_draw_circle(SDL_Renderer* renderer, float cx, float cy, float radius, uint32_t rgb, uint8_t alpha = 0xFFU);
    void game_draw_circle(SDL_Renderer* renderer, float cx, float cy, float radius, float hue, float saturation = 1.0f, float value = 1.0f, uint8_t alpha = 0xFFU);
    void game_fill_circle(SDL_Renderer* renderer, float cx, float cy, float radius, uint32_t rgb, uint8_t alpha = 0xFFU);
    void game_fill_circle(SDL_Renderer* renderer, float cx, float cy, float radius, float hue, float saturation = 1.0f, float value = 1.0f, uint8_t alpha = 0xFFU);

    void game_draw_ellipse(SDL_Renderer* renderer, float cx, float cy, float aradius, float bradius, uint32_t rgb, uint8_t alpha = 0xFFU);
    void game_draw_ellipse(SDL_Renderer* renderer, float cx, float cy, float aradius, float bradius, float hue, float saturation = 1.0f, float value = 1.0f, uint8_t alpha = 0xFFU);
    void game_fill_ellipse(SDL_Renderer* renderer, float cx, float cy, float aradius, float bradius, uint32_t rgb, uint8_t alpha = 0xFFU);
    void game_fill_ellipse(SDL_Renderer* renderer, float cx, float cy, float aradius, float bradius, float hue, float saturation = 1.0f, float value = 1.0f, uint8_t alpha = 0xFFU);
}
